...
# formatted_categories = [category.format() for category in categories]
    ...
    def search_questions():
        search_term= Question.query.filter(Question.question.ilike(f'%{title}%')).all()
        ...
        # questions = Question.query.filter(Question.tags.ilike(search_term)).all()
    """
    @TODO:
